...
public class Library {
	...
	public static String readproperties(WebDriver driver, String key) throws IOException {
		InputStream fs = new FileInputStream(
				"C:\\Users\\Saaneel\\eclipse-workspace\\UnitedSpritFreamworks\\src\\test\\Resources\\Properties\\Locator.properties");
	...
	public static String readexcel(WebDriver driver, int rownum, int colnum) throws IOException {
		FileInputStream fit = new FileInputStream("C:\\Users\\Saaneel\\eclipse-workspace\\UnitedSpritFreamworks\\src\\test\\Resources\\Properties\\UAAATestData.xlsx");
...
//		FileUtils.copyFile(src, new File("C:\Users\Saaneel\eclipse-workspace\UnitedSpritFreamworks\test-output\Screenshot"));
//	}
